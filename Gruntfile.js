...
module.exports = function(grunt) {
    ...
    grunt.config.init({
        ...
        shell: {
            ...
            pack_firefox: {
                command: function () {
                    //var cmd = "cd " + config.firefox.workingDir + " && echo " + grunt.file.expand({ cwd: config.firefox.workingDir }, "**").join(" ") + " | tr ' ' '\n' | " + config.path.zip + " " + config.firefoxWebExt.outputFile + " -@";
                    var cmd = "" + config.path.firefox+ " build -s '" + config.firefox.workingDir + "' -a '" + config.buildDir + "'";
                    console.log(cmd);
                    return cmd;
                }
            },
