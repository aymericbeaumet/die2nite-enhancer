...
PLACEHOLDERS=(
  ...
  '__DESCRIPTION__=Die2Nite Enhancer is an extension allowing you to improve you game experience on the browser game Die2Nite. It also works with the versions in French (Hordes), Spanish (Zombinoia) and Dutch (Die Verdammten).'
  '__VERSION__=0.0.1'
