			...
			load: function() {
				document.addEventListener('d2n_gamebody_reload', function() {
					...
					if($("#" + DESPAIR_DEATH_ID).length == 0) {
						$("#sideMap").after("<div id='" + DESPAIR_DEATH_ID+ "'><div class='block tutorialBlock'><div class='header'></div><div class='bg content'>" + I18N.get(MODULE_NAME + "_to_kill") + " : " + nbKills + "</div><div class='footer'></div></div></div>");
					} else {
