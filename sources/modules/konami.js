Module.register(function() {
	...
	function add_i18n()
	{
		...
		i18n[I18N.LANG.EN][MODULE_NAME + '_wtf'] = "What's the point?";
		...
		i18n[I18N.LANG.FR][MODULE_NAME + '_wtf'] = "Quel intérêt ?";
	...
	function inject_easter_eggs(){
		if (D2N.is_on_gazette()) {
			JS.wait_for_selector("div.news div.sign", function(el) {
				el.innerText = "- Quelqu'un";
			}.bind(this));
		}

		D2N.is_in_town(function(in_town){
			if(in_town){
				JS.wait_for_id("clock", function(el) {
					$(el).attr("onclick", "");
					$(el).on('click', function(){
						alert(I18N.get(MODULE_NAME + "_wtf"));
					});
				}.bind(this));
			}
		});
